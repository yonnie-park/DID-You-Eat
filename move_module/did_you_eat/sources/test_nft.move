module pub_addr::did_you_eat {
    ...
    public entry fun set_meta(minter: &signer, collection_name: string::String, description: string::String, collection_uri: string::String, token_name: string::String, token_uri: string::String) acquires SignData{
